    ...
    public class UmbracoCommunityHtmlExporterApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Html Exporter Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityHtmlExporterOperationSecurityFilter>();
            });
        }

        public class
            UmbracoCommunityHtmlExporterOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        {
            public CustomOperationHandler(IOptions<ApiVersioningOptions> apiVersioningOptions) : base(
                ...
                ControllerActionDescriptor controllerActionDescriptor)
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(
                    "Umbraco.Community.HtmlExporter.Controllers",
