...
namespace Umbraco.Community.HtmlExporter.Controllers
{
    ...
    public class UmbracoCommunityHtmlExporterApiController : UmbracoCommunityHtmlExporterApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoCommunityHtmlExporterApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
